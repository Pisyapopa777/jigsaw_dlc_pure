...
public class ModelBazhenPig<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("jigsaw_ponos_dlc", "model_bazhen_pig"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r1 = body.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(32, 16).addBox(-2.0F, -10.0F, -10.0F, 4.0F, 4.0F, 12.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 4.0F, -5.0F, -0.3054F, 0.0F, 0.0F));
		PartDefinition rotation = body.addOrReplaceChild("rotation", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -4.0F, 2.0F, 1.5708F, 0.0F, 0.0F));
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -7.5F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(16, 16).addBox(-2.0F, 1.0F, -8.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
