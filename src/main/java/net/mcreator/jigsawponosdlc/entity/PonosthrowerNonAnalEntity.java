...
import net.mcreator.jigsawponosdlc.procedures.PonosthrowerNonAnalWhileProjectileFlyingTickProcedure;
import net.mcreator.jigsawponosdlc.procedures.PonosthrowerNonAnalProjectileHitsLivingEntityProcedure;
import net.mcreator.jigsawponosdlc.procedures.PonosthrowerNonAnalProjectileHitsBlockProcedure;
...
public class PonosthrowerNonAnalEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		PonosthrowerNonAnalProjectileHitsLivingEntityProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		PonosthrowerNonAnalProjectileHitsBlockProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}

	@Override
	public void tick() {
		super.tick();
		PonosthrowerNonAnalWhileProjectileFlyingTickProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this.getOwner(), this);
		if (this.inGround)
			this.discard();
	}
