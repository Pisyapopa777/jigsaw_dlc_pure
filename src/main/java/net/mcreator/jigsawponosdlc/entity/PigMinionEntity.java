...
public class PigMinionEntity extends Monster {
	public PigMinionEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JigsawPonosDlcModEntities.PIG_MINION.get(), world);
	}

	public PigMinionEntity(EntityType<PigMinionEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
