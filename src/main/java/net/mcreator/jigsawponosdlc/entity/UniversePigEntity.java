...
import net.mcreator.jigsawponosdlc.procedures.UniversePigSpawnGayruleProcedure;
...
public class UniversePigEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.AMBIENT).add(new MobSpawnSettings.SpawnerData(JigsawPonosDlcModEntities.UNIVERSE_PIG.get(), 8, 1, 1));
	}
	...
	public static void init() {
		SpawnPlacements.register(JigsawPonosDlcModEntities.UNIVERSE_PIG.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return UniversePigSpawnGayruleProcedure.execute(world);
		});
		DungeonHooks.addDungeonMob(JigsawPonosDlcModEntities.UNIVERSE_PIG.get(), 180);
	}
